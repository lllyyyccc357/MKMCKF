function [R_ORI_MKMC,QUAT_ORI_MKMC]=MR_MKMCIEKF(acc, gyr, mag, t, stdAcc, stdGyro, stdMag, sigma_acc,sigma_mag)
...
%         z=[za;zm];
    ...
    R_proi=X_t;
    Ppriori=(eye(3)-K_acc*H_acc)*Ppriori;
     if (rem(i,4)==1)
