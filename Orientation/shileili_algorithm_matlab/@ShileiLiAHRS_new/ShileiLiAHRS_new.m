classdef ShileiLiAHRS_new < handle
...
%% Public properties
    ...
    methods (Access = public)
        function obj = ShileiLiAHRS_new(varargin)
            obj.cnt=0;
            for i = 1:2:nargin
        ...
        function obj = Update(obj, Gyroscope, Accelerometer, Magnetometer)
            ...
            %% project it into the horizontal lelve
            magref_fixedframe=[0,0,0,1];
            q_acc_s=quaternConj(q);
            q3=quaternProd(q_acc_s,magref_fixedframe);
            gravref_imuframe=quaternProd(q3,q);
            Magnetometer       = (Magnetometer' - (gravref_imuframe(2:4)*Magnetometer')*gravref_imuframe(2:4)')';   
            %%
